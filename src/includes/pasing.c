 ...
 * As tabelas ht_user_ride e ht_driver_ride vaõ ser um catálogos onde guardam respetivamente para cada utilizador 
 * como chave da tabela a viagem que ele fez e para cada condutor a viagem que ele concluiu 
 * 
